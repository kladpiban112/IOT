                    ...
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                19.29k </p>
                            <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Creative Filtered
                                    Portrait</a></h5>
                ...
                <div class="col-lg-4 product-item music crypto-card games">
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                23.63k </p>
                            <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">The Chirstoper</a>
                            </h5>
                ...
                <div class="col-lg-4 product-item artwork music games">
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                15.93k </p>
                            <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Evolved Reality</a>
                            </h5>
                ...
                <div class="col-lg-4 product-item crypto-card 3d-style">
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                14.85k </p>
                            <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Abstract Face
                                    Painting</a></h5>
                ...
                <div class="col-lg-4 product-item games music 3d-style">
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                64.10k </p>
                            <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Long-tailed
                                    Macaque</a></h5>
                ...
                <div class="col-lg-4 product-item artwork music crypto-card">
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                36.42k </p>
                            <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Robotic Body Art</a>
                            </h5>
                            <p class="text-muted mb-0">Artwork</p>
                        </div>
                        <div class="card-footer border-top border-top-dashed">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="#!" class="float-end"> View All <i
                                                class="ri-arrow-right-line align-bottom"></i></a>
                                        <h5 class="mb-0 fs-16"><a href="#!" class="link-dark">Artwork <span
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="#!" class="float-end"> View All <i
                                                class="ri-arrow-right-line align-bottom"></i></a>
                                        <h5 class="mb-0 fs-16"><a href="#!" class="link-dark">Crypto Card <span
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="#!" class="float-end"> View All <i
                                                class="ri-arrow-right-line align-bottom"></i></a>
                                        <h5 class="mb-0 fs-16"><a href="#!" class="link-dark">Music <span
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="#!" class="float-end"> View All <i
                                                class="ri-arrow-right-line align-bottom"></i></a>
                                        <h5 class="mb-0 fs-16"><a href="#!" class="link-dark">Games <span
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="#!" class="float-end"> View All <i
                                                class="ri-arrow-right-line align-bottom"></i></a>
                                        <h5 class="mb-0 fs-16"><a href="#!" class="link-dark">Photography <span
                    ...
                    <div class="card explore-box card-animate border">
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                ...
                                <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.php" class="link-dark">Patterns
                                        arts &amp; culture</a></h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card explore-box card-animate border">
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                ...
                                <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.php" class="link-dark">Evolved
                                        Reality</a></h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card explore-box card-animate border">
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                ...
                                <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.php"
