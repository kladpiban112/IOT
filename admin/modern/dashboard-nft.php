                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Walking On Air</a></h5>
                                                <p class="text-muted mb-0">Artwork</p>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Filtered Portrait</a></h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Patterns Arts & Culture</a></h5>
                                                <p class="text-muted mb-0">Artwork</p>
                                            </div>
                                            <div class="card-footer border-top border-top-dashed">
                                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Evolved Reality</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Abstract Face Painting</a></h6>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Long-tailed Macaque</a></h6>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Robotic Body Art</a></h6>
                                                                <p class="text-muted mb-0">Photography</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Smillevers Crypto</a></h6>
                                                                <p class="text-muted mb-0">Artworks</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Creative Filtered Portrait</a></h6>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">The Chirstoper</a></h6>
