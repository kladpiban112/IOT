            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-tachometer-alt"></i> <span><?=$lang['t-dashboards']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="lab la-delicious"></i> <span><?=$lang['t-apps']?></span>
                    </a>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarnft">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-creators.php" class="nav-link" data-key="t-creators">
                                            <?=$lang['t-creators']?>  </a>
                                        </li>
                                        <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-columns"></i> <span><?=$lang['t-layouts']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAuth" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="lar la-user-circle"></i> <span><?=$lang['t-authentication']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarPages" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-pager"></i> <span><?=$lang['t-pages']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarUI" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-pencil-ruler"></i> <span><?=$lang['t-base-ui']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAdvanceUI" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-briefcase"></i> <span><?=$lang['t-advance-ui']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="widgets.php">
                        <i class="las la-flask"></i> <span><?=$lang['t-widgets']?></span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarForms" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="lar la-newspaper"></i> <span><?=$lang['t-forms']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarTables" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-table"></i> <span><?=$lang['t-tables']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarCharts" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-chart-pie"></i> <span><?=$lang['t-charts']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarIcons" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="lab la-fonticons"></i> <span><?=$lang['t-icons']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarMaps" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-map"></i> <span><?=$lang['t-maps']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarMultilevel" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-folder-plus"></i> <span><?=$lang['t-multi-level']?></span>
                    </a>
