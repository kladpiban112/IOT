                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card overflow-hidden">
                                    <div class="card-body bg-marketplace d-flex">
                                        <div class="flex-grow-1">
                                            <h4 class="fs-18 lh-base fw-bold mb-0">Discover, Collect, Sell and Create
                                                <br> your own <span class="text-success">NFTs.</span> </h4>
                                            <p class="mb-0 mt-2 pt-1 text-muted">The world's first and largest digital
                                                marketplace.</p>
                                            <div class="d-flex gap-3 mt-4">
                                                <a href="" class="btn btn-primary">Discover Now </a>
                                                    ...
                                                    <div class="w-100">
                                                        <div class="d-flex align-items-center">
                                                            <img src="assets/images/nft/gif/img-2.gif"
                                                                ...
                                                                alt="">
                                                            <div class="ms-3 flex-grow-1">
                                                                <h5 class="fs-16 mb-1 fw-bold">Trendy Fashion Portraits
                                                                </h5>
                                                                <p class="text-muted mb-0">Artwork</p>
                                                            </div>
                                                            <div class="dropdown">
