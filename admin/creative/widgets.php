                                    ...
                                    <div class="card-body p-0">
                                        <div class="row row-cols-md-3 row-cols-1">
                                            <div class="col col-lg border-end">
                                                <div class="py-4 px-3">
                                                    <h5 class="text-muted text-uppercase fs-14">Campaign Sent <i class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i></h5>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                            ...
                                            <div class="col col-lg border-end">
                                                <div class="mt-3 mt-md-0 py-4 px-3">
                                                    <h5 class="text-muted text-uppercase fs-14">Lead Coversation <i class="ri-arrow-down-circle-line text-danger fs-18 float-end align-middle"></i></h5>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                            ...
                                            <div class="col col-lg border-end">
                                                <div class="mt-3 mt-lg-0 py-4 px-3">
                                                    <h5 class="text-muted text-uppercase fs-14">Daily Average Income <i class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i></h5>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                            ...
                                            <div class="col col-lg">
                                                <div class="mt-3 mt-lg-0 py-4 px-3">
                                                    <h5 class="text-muted text-uppercase fs-14">Annual Deals <i class="ri-arrow-down-circle-line text-danger fs-18 float-end align-middle"></i></h5>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                    ...
                                                    <div class="acitivity-timeline acitivity-main">
                                                        ...
                                                        <div class="acitivity-item py-3 d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                ...
                                                                <p class="text-muted mb-0">Flash sale by <a href="javascript:void(0);" class="link-secondary fw-semibold">Zoetic Fashion</a></p>
                                            ...
                                            <li class="list-group-item px-0">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-2">
                                                        ...
                                                        <p class="fs-14 mb-0 text-muted"><i class="mdi mdi-circle fs-10 align-middle text-primary me-1"></i>BTC</p>
                                                    </div>
                                            ...
                                            <li class="list-group-item px-0">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-2">
                                                        ...
                                                        <p class="fs-14 mb-0 text-muted"><i class="mdi mdi-circle fs-10 align-middle text-info me-1"></i>ETH</p>
                                                    </div>
                                                    <div class="flex-shrink-0 text-end">
                                            ...
                                            <li class="list-group-item px-0">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-2">
                                                        ...
                                                        <p class="fs-14 mb-0 text-muted"><i class="mdi mdi-circle fs-10 align-middle text-warning me-1"></i>LTC</p>
                                                    </div>
                                                    <div class="flex-shrink-0 text-end">
                                            ...
                                            <li class="list-group-item px-0 pb-0">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-2">
                                                        ...
                                                        <p class="fs-14 mb-0 text-muted"><i class="mdi mdi-circle fs-10 align-middle text-success me-1"></i>DASH</p>
                                                    </div>
                                                    <div class="flex-shrink-0 text-end">
