                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarEmail">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-mailbox.php" class="nav-link" data-key="t-mailbox">
                                                <?=$lang['t-mailbox']?> </a>
                                        </li>
                                        <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarForms">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="forms-select2.php" class="nav-link" data-key="t-select2"><?=$lang['t-select2']?> <span class="badge badge-pill bg-danger" data-key="t-new"><?=$lang['t-select2']?></span></a>
                            </li>
                        </ul>
                    </div>
                </li>
