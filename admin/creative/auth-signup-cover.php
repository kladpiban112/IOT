                                ...
                                <div class="p-lg-5 p-4">
                                    ...
                                    <div class="mt-4">
                                        <form class="needs-validation" novalidate action="index.php">
                                            ...
                                            <div class="mb-4">
                                                <p class="mb-0 fs-13 text-muted fst-italic">By registering you agree to
                                                    the Velzon <a href="#" class="text-primary text-decoration-underline fst-normal fw-semibold">Terms
                                                        of Use</a></p>
                                            </div>
