                        ...
                        <div class="card product">
                            <div class="card-body">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-sm">
                                        <h5 class="fs-15 text-truncate"><a href="ecommerce-product-detail.php" class="text-dark">Sweatshirt for Men (Pink)</a></h5>
                        ...
                        <div class="card product">
                            <div class="card-body">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-sm">
                                        <h5 class="fs-15 text-truncate"><a href="ecommerce-product-detail.php" class="text-dark">Noise NoiseFit Endure Smart Watch</a></h5>
                        ...
                        <div class="card product">
                            <div class="card-body">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-sm">
                                        <h5 class="fs-15 text-truncate"><a href="ecommerce-product-detail.php" class="text-dark">350 ml Glass Grocery Container</a></h5>
