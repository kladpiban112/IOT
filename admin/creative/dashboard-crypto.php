                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-6">
                                                        <div class="d-flex flex-wrap gap-4 align-items-center">
                                                            ...
                                                            <p class="fw-semibold text-muted mb-0">Low <span class="text-dark fs-13 ms-1">0.0175489</span>
                                                            </p>
                                                        </div>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-end g-0">
                                                <div class="col-6">
                                                    ...
                                                    <p class="text-success fw-semibold mb-0">+13.11%<span class="text-muted ms-2 fs-13 text-uppercase">(btc)</span>
                                                    </p>
                                                </div><!-- end col -->
                                                <div class="col-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-end g-0">
                                                <div class="col-6">
                                                    ...
                                                    <p class="text-success fw-semibold mb-0">+15.08%<span class="text-muted ms-2 fs-13 text-uppercase">(ltc)</span>
                                                    </p>
                                                </div><!-- end col -->
                                                <div class="col-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-end g-0">
                                                <div class="col-6">
                                                    ...
                                                    <p class="text-success fw-semibold mb-0">+08.57%<span class="text-muted ms-2 fs-13 text-uppercase">(etc)</span>
                                                    </p>
                                                </div><!-- end col -->
                                                <div class="col-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-end g-0">
                                                <div class="col-6">
                                                    ...
                                                    <p class="text-success fw-semibold mb-0">+12.07%<span class="text-muted ms-2 fs-13 text-uppercase">(dash)</span>
                                                    </p>
                                                </div><!-- end col -->
                                                <div class="col-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-end g-0">
                                                <div class="col-6">
                                                    ...
                                                    <p class="text-success fw-semibold mb-0">+14.99%<span class="text-muted ms-2 fs-13 text-uppercase">(usdt)</span>
                                                    </p>
                                                </div><!-- end col -->
                                                <div class="col-6">
