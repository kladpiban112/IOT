                            ...
                            <div class="row">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="row g-3">
                                            <div class="col-lg-3 col-6">
                                                <p class="text-muted mb-2 text-uppercase fw-semibold fs-13">Invoice No
                                                </p>
                                            ...
                                            <!--end col-->
                                            <div class="col-lg-3 col-6">
                                                <p class="text-muted mb-2 text-uppercase fw-semibold fs-13">Payment
                                                    Status</p>
                                            ...
                                            <!--end col-->
                                            <div class="col-lg-3 col-6">
                                                <p class="text-muted mb-2 text-uppercase fw-semibold fs-13">Total Amount
                                                </p>
                                ...
                                <div class="col-lg-12">
                                    <div class="card-body p-4 border-top border-top-dashed">
                                        <div class="row g-3">
                                            <div class="col-6">
                                                <h6 class="text-muted text-uppercase fw-semibold mb-3 fs-13">Billing
                                                    Address
                                                </h6>
                                            ...
                                            <!--end col-->
                                            <div class="col-6">
                                                <h6 class="text-muted text-uppercase fw-semibold mb-3 fs-13">Shipping
                                                    Address
                                                </h6>
                                ...
                                <div class="col-lg-12">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="mt-3">
                                            <h6 class="text-muted text-uppercase fw-semibold mb-3 fs-13">Payment
                                                Details:</h6>
