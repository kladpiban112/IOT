<?php include 'layouts/head-session.php'; ?>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-6">
                                                        <div class="d-flex flex-wrap gap-4 align-items-center">
                                                            ...
                                                            <p class="fw-semibold text-muted mb-0">$75.69 <span class="text-success fs-12 ms-1">+1.99%</span>
                                                            </p>
                                                            <p class="fw-semibold text-muted mb-0">High <span class="text-dark fs-12 ms-1">0.014578</span></p>
                                                            <p class="fw-semibold text-muted mb-0">Low <span class="text-dark fs-12 ms-1">0.0175489</span>
                                                            </p>
                                                        </div>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-end g-0">
                                                <div class="col-6">
                                                    ...
                                                    <p class="text-success fs-14 fw-semibold mb-0">+13.11%<span class="text-muted ms-2 fs-12 text-uppercase">(btc)</span>
                                                    </p>
                                                </div><!-- end col -->
                                                <div class="col-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-end g-0">
                                                <div class="col-6">
                                                    ...
                                                    <p class="text-success fs-14 fw-semibold mb-0">+15.08%<span class="text-muted ms-2 fs-12 text-uppercase">(ltc)</span>
                                                    </p>
                                                </div><!-- end col -->
                                                <div class="col-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-end g-0">
                                                <div class="col-6">
                                                    ...
                                                    <p class="text-success fs-14 fw-semibold mb-0">+08.57%<span class="text-muted ms-2 fs-12 text-uppercase">(etc)</span>
                                                    </p>
                                                </div><!-- end col -->
                                                <div class="col-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-end g-0">
                                                <div class="col-6">
                                                    ...
                                                    <p class="text-danger fs-14 fw-semibold mb-0">-09.21%<span class="text-muted ms-2 fs-12 text-uppercase">(bnb)</span>
                                                    </p>
                                                </div><!-- end col -->
                                                <div class="col-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-end g-0">
                                                <div class="col-6">
                                                    ...
                                                    <p class="text-success fs-14 fw-semibold mb-0">+12.07%<span class="text-muted ms-2 fs-12 text-uppercase">(dash)</span>
                                                    </p>
                                                </div><!-- end col -->
                                                <div class="col-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-end g-0">
                                                <div class="col-6">
                                                    ...
                                                    <p class="text-success fs-14 fw-semibold mb-0">+14.99%<span class="text-muted ms-2 fs-12 text-uppercase">(usdt)</span>
                                                    </p>
                                                </div><!-- end col -->
                                                <div class="col-6">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-end g-0">
                                                <div class="col-6">
                                                    ...
                                                    <p class="text-danger fs-14 fw-semibold mb-0">-05.07%<span class="text-muted ms-2 fs-12 text-uppercase">(neo)</span>
                                                    </p>
                                                </div><!-- end col -->
                                                <div class="col-6">
