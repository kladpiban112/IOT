                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3 flex-grow-1">
                                        ...
                                        <p class="text-muted fs-14 fs-14 mb-0"><i
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3 flex-grow-1">
                                        ...
                                        <p class="text-muted fs-14 fs-14 mb-0"><i
                                                class="mdi mdi-ethereum text-primary fs-14"></i> 34,754 ETH</p>
                                    </div>
                                    <div>
                                        <div class="dropdown float-end">
                                            <button class="btn btn-ghost-primary btn-icon dropdown" type="button"
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3 flex-grow-1">
                                        ...
                                        <p class="text-muted fs-14 fs-14 mb-0"><i
                                                class="mdi mdi-ethereum text-primary fs-14"></i> 26,834 ETH</p>
                                    </div>
                                    <div>
                                        <div class="dropdown float-end">
                                            <button class="btn btn-ghost-primary btn-icon dropdown" type="button"
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3 flex-grow-1">
                                        ...
                                        <p class="text-muted fs-14 fs-14 mb-0"><i
                                                class="mdi mdi-ethereum text-primary fs-14"></i> 18,034 ETH</p>
                                    </div>
                                    <div>
                                        <div class="dropdown float-end">
                                            <button class="btn btn-ghost-primary btn-icon dropdown" type="button"
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3 flex-grow-1">
                                        ...
                                        <p class="text-muted fs-14 fs-14 mb-0"><i
                                                class="mdi mdi-ethereum text-primary fs-14"></i> 63,710 ETH</p>
                                    </div>
                                    <div>
                                        <div class="dropdown float-end">
                                            <button class="btn btn-ghost-primary btn-icon dropdown" type="button"
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="text-muted fs-14">You can make an NFT of a digital painting, a text, a piece
                                    of music, a video.</p>
