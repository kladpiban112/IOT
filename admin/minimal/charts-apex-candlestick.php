                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="basic_candlestick" data-colors='["--vz-success", "--vz-primary"]'
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div>
                                    <div id="combo_candlestick" data-colors='["--vz-info", "--vz-primary"]'
                                        class="apex-charts" dir="ltr"></div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="category_candlestick"
                                    data-colors='["--vz-success-rgb, 0.65", "--vz-danger-rgb, 0.65"]'
                                    class="apex-charts" dir="ltr"></div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div>
