                            ...
                            <div class="col-xl-3 col-lg-6">
                                <div class="card ribbon-box right overflow-hidden">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php" class="link-secondary">Force Medicines</a></h5>
                            ...
                            <div class="col-xl-3 col-lg-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php" class="link-secondary">Micro Design</a></h5>
                            ...
                            <div class="col-xl-3 col-lg-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php" class="link-secondary">Nesta Technologies</a></h5>
                            ...
                            <div class="col-xl-3 col-lg-6">
                                <div class="card ribbon-box right overflow-hidden">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php" class="link-secondary">iTest Factory</a></h5>
                            ...
                            <div class="col-xl-3 col-lg-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php" class="link-secondary">Meta4Systems</a></h5>
                            ...
                            <div class="col-xl-3 col-lg-6">
                                <div class="card ribbon-box right overflow-hidden">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php" class="link-secondary">Digitech Galaxy</a></h5>
                            ...
                            <div class="col-xl-3 col-lg-6">
                                <div class="card ribbon-box right overflow-hidden">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php" class="link-secondary">Syntyce Solutions</a></h5>
                            ...
                            <div class="col-xl-3 col-lg-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php" class="link-secondary">Zoetic Fashion</a></h5>
