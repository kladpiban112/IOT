            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="dashboard-nft.php" class="nav-link" data-key="t-nft"> <?=$lang['t-nft']?>
                                    <span class="badge badge-pill bg-danger" data-key="t-new"><?=$lang['t-new']?></span></a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button"
                        ...
                        <i data-feather="grid" class="icon-dual"></i> <span><?=$lang['t-apps']?></span>
                    </a>
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="#sidebaremailTemplates" class="nav-link" data-bs-toggle="collapse"
                                                ...
                                                <?=$lang['t-email-templates']?> <span class="badge badge-pill bg-danger"
                                                    data-key="t-new"><?=$lang['t-new']?></span>
                                            </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button"
                        ...
                        <i data-feather="layout" class="icon-dual"></i> <span><?=$lang['t-layouts']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarPages" data-bs-toggle="collapse" role="button"
                        ...
                        <i data-feather="command" class="icon-dual"></i> <span><?=$lang['t-pages']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarUI" data-bs-toggle="collapse" role="button"
                        ...
                        <i data-feather="package" class="icon-dual"></i> <span><?=$lang['t-base-ui']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAdvanceUI" data-bs-toggle="collapse" role="button"
                        ...
                        <i data-feather="layers" class="icon-dual"></i> <span><?=$lang['t-advance-ui']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="widgets.php">
                        <i data-feather="copy" class="icon-dual"></i> <span><?=$lang['t-widgets']?></span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarForms" data-bs-toggle="collapse" role="button"
                        ...
                        <i data-feather="file-text" class="icon-dual"></i> <span><?=$lang['t-forms']?></span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarForms">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="forms-select2.php" class="nav-link" data-key="t-select2"><?=$lang['t-select2']?> <span
                                        class="badge badge-pill bg-danger" data-key="t-new"><?=$lang['t-new']?></span></a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarTables" data-bs-toggle="collapse" role="button"
                        ...
                        <i data-feather="database" class="icon-dual"></i> <span><?=$lang['t-tables']?></span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarTables">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="tables-datatables.php" class="nav-link" data-key="t-datatables"><?=$lang['t-datatables']?>
                                    <span class="badge badge-pill bg-danger" data-key="t-new"><?=$lang['t-new']?></span></a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarCharts" data-bs-toggle="collapse" role="button"
                        ...
                        <i data-feather="pie-chart" class="icon-dual"></i> <span><?=$lang['t-charts']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarIcons" data-bs-toggle="collapse" role="button"
                        ...
                        <i data-feather="archive" class="icon-dual"></i> <span><?=$lang['t-icons']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarMaps" data-bs-toggle="collapse" role="button"
                        ...
                        <i data-feather="map-pin" class="icon-dual"></i> <span><?=$lang['t-maps']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarMultilevel" data-bs-toggle="collapse" role="button"
                        ...
                        <i data-feather="share-2" class="icon-dual"></i> <span><?=$lang['t-multi-level']?></span>
                    </a>
