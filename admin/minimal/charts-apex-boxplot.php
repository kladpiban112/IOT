                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="basic_box" data-colors='["--vz-primary", "--vz-info"]' class="apex-charts"
                                    dir="ltr"></div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="box_plot"
                                    data-colors='["--vz-succcess", "--vz-info", "--vz-gray-300", "--vz-primary"]'
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="box_plot_hori" data-colors='["--vz-light", "--vz-card-bg"]' class="apex-charts"
                                    dir="ltr"></div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div>
