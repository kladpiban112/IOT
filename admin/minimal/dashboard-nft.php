                ...
                <div class="row dash-nft">
                    ...
                    <div class="col-xxl-3">
                        <div class="card">
                            ...
                            <div>
                                <div id="market-overview" data-colors='["--vz-gray-200", "--vz-primary"]'
                                ...
                                <div class="swiper-slide">
                                    <div class="card explore-box card-animate rounded">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="mb-1"><a href="apps-nft-item-details.php"
                                                    class="link-dark">Walking On Air</a></h5>
                                            <p class="text-muted mb-0">Artwork</p>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card explore-box card-animate rounded">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="mb-1"><a href="apps-nft-item-details.php"
                                                    class="link-dark">Filtered Portrait</a></h5>
                                ...
                                <div class="swiper-slide">
                                    <div class="card explore-box card-animate rounded">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="mb-1"><a href="apps-nft-item-details.php"
                                                    class="link-dark">Patterns Arts & Culture</a></h5>
                                            <p class="text-muted mb-0">Artwork</p>
                                        </div>
                                        <div class="card-footer border-top border-top-dashed">
                                            <div class="d-flex align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <div class="card explore-box card-animate rounded">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="mb-1"><a href="apps-nft-item-details.php"
                                                    class="link-dark">Evolved Reality</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h6 class="mb-1"><a href="apps-nft-item-details.php"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h6 class="mb-1"><a href="apps-nft-item-details.php"
                                                                    class="link-dark">Creative Filtered Portrait</a>
                                                            </h6>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3 flex-grow-1">
                                                    ...
                                                    <p class="text-muted mb-0"><i
                                                            class="mdi mdi-ethereum text-primary fs-15"></i> 81,369 ETH
                                                    </p>
                                                </div>
                                                <div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3 flex-grow-1">
                                                    ...
                                                    <p class="text-muted mb-0"><i
                                                            class="mdi mdi-ethereum text-primary fs-15"></i> 4,754 ETH
                                                    </p>
                                                </div>
                                                <div>
                                                    <div class="dropdown float-end">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3 flex-grow-1">
                                                    ...
                                                    <p class="text-muted mb-0"><i
                                                            class="mdi mdi-ethereum text-primary fs-15"></i> 68,945 ETH
                                                    </p>
                                                </div>
                                                <div>
                                                    <div class="dropdown float-end">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3 flex-grow-1">
                                                    ...
                                                    <p class="text-muted mb-0"><i
                                                            class="mdi mdi-ethereum text-primary fs-15"></i> 49,031 ETH
                                                    </p>
                                                </div>
                                                <div>
                                                    <div class="dropdown float-end">
