                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-sm-auto ms-auto">
                                        <div class="list-grid-nav hstack gap-1">
                                            <button type="button" id="grid-view-button" class="btn btn-soft-primary nav-link btn-icon fs-14 active filter-button"><i class="ri-grid-fill"></i></button>
                                            <button type="button" id="list-view-button" class="btn btn-soft-primary nav-link  btn-icon fs-14 filter-button"><i class="ri-list-unordered"></i></button>
                                            ...
                                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addmembers"><i class="ri-add-fill me-1 align-bottom"></i> Add Members</button>
                                        </div>
                                    </div><!--end col-->
                                </div><!--end row-->
                            </div>
                                                ...
                                                <div class="card-body p-4">
                                                    <div class="row align-items-center team-row">
                                                        ...
                                                        <div class="col-lg-4 col">
                                                            <div class="team-profile-img">
                                                                <div class="avatar-lg img-thumbnail rounded-circle flex-shrink-0">
                                                                    <div class="avatar-title border bg-soft-primary text-primary rounded-circle">
                                                                        DP
                                                                    </div>
                                                                </div>
                                                                <div class="team-content">
                                            ...
                                            <div class="p-3 border-top">    
                                                ...
                                                <div class="d-flex mb-3">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h6 class="mb-1"><a href="javascript:void(0);" class="link-secondary">Images</a></h6>
                                                ...
                                                <div class="d-flex mb-3">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h6 class="mb-1"><a href="javascript:void(0);" class="link-secondary">Documents</a></h6>
                                                ...
                                                <div class="d-flex mb-3">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h6 class="mb-1"><a href="javascript:void(0);" class="link-secondary">Media</a></h6>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h6 class="mb-1"><a href="javascript:void(0);" class="link-secondary">Others</a></h6>
