                                        ...
                                        <table class="main" width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr style="font-family: 'Roboto', sans-serif; font-size: 14px; margin: 0;">
                                                <td class="content-wrap"
                                                    style="font-family: 'Roboto', sans-serif; box-sizing: border-box; color: #495057; font-size: 14px; vertical-align: top; margin: 0;padding: 30px;border-radius: 7px; background-color: #fff; border: 1px solid #e9ebec;"
                                                    valign="top">
