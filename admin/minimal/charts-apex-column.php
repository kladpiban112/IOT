                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="column_chart" data-colors='["--vz-info", "--vz-primary", "--vz-success"]'
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="column_stacked"
                                    data-colors='["--vz-primary", "--vz-success", "--vz-info", "--vz-gray-200"]'
                                    class="apex-charts" dir="ltr"></div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="column_markers" data-colors='["--vz-primary", "--vz-success"]'
                                    class="apex-charts" dir="ltr"></div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="column_range" data-colors='["--vz-primary", "--vz-info"]' class="apex-charts"
                                    dir="ltr"></div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div>
