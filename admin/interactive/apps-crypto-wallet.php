                                            ...
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                ...
                                                <tbody class="list form-check-all">
                                                    <tr>
                                                        ...
                                                        <td class="returns_per"><h6 class="text-success fs-14 mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>0.63%</h6></td>
                                                    </tr><!--end tr-->
                                                    <tr>
                                                        ...
                                                        <td class="returns_per"><h6 class="text-danger fs-14 mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>3.42%</h6></td>
                                                    </tr><!--end tr-->
                                                    <tr>
                                                        ...
                                                        <td class="returns_per"><h6 class="text-success fs-14 mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>1.20%</h6></td>
                                                    </tr><!--end tr-->
                                                    <tr>
                                                        ...
                                                        <td class="returns_per"><h6 class="text-danger fs-14 mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>1.92%</h6></td>
                                                    </tr><!--end tr-->
                                                    <tr>
                                                        ...
                                                        <td class="returns_per"><h6 class="text-danger fs-14 mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>0.87%</h6></td>
                                                    </tr><!--end tr-->
                                                    <tr>
                                                        ...
                                                        <td class="returns_per"><h6 class="text-success fs-14 mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>3.96%</h6></td>
                                                    </tr><!--end tr-->
                                                    <tr>
                                                        ...
                                                        <td class="returns_per"><h6 class="text-success fs-14 mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>0.36%</h6></td>
                                                    </tr><!--end tr-->
                                                    <tr>
