                            ...
                            <div class="flex-shrink-0">
                                <div class="dropdown card-header-dropdown">
                                    <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown"
                                        ...
                                        <span class="fw-semibold text-muted fs-14">Priority<i
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex mb-2">
                                            <h6 class="fs-16 mb-0 flex-grow-1 text-truncate task-title"><a
                                                    href="apps-tasks-details.php" class="link-dark d-block">Profile
                                                    Page
                                                    Satructure</a></h6>
                                            <div class="dropdown">
                                        ...
                                        <div class="d-flex mb-2">
                                            <div class="flex-grow-1">
                                                <h6 class="fs-16 mb-0 text-truncate task-title"><a
                                                        ...
                                                        class="link-dark d-block">Marketing &
                                                        Sales</a></h6>
                                            </div>
                                            <div class="flex-shrink-0">
                            ...
                            <div id="inprogress-task" class="tasks">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex mb-2">
                                            <a href="javascript:void(0)"
                                                class="text-muted fw-semibold fs-14 flex-grow-1">#VL2457</a>
                                            <div class="dropdown">
                                ...
                                <div class="card tasks-box">
                                    <div class="card-body">
                                        <div class="d-flex mb-2">
                                            <a href="javascript:void(0)"
                                                class="text-muted fw-semibold fs-14 flex-grow-1">#VL2743</a>
                                            <div class="dropdown">
                            ...
                            <div id="reviews-task" class="tasks">
                                <div class="card tasks-box">
                                    <div class="card-body">
                                        <div class="d-flex mb-2">
                                            <a href="javascript:void(0)"
                                                class="text-muted fw-semibold fs-14 flex-grow-1">#VL2453</a>
                                            <div class="dropdown">
                                ...
                                <div class="card tasks-box">
                                    <div class="card-body">
                                        <div class="d-flex mb-2">
                                            <a href="javascript:void(0)"
                                                class="text-muted fw-semibold fs-14 flex-grow-1">#VL2340</a>
                                            <div class="dropdown">
                                ...
                                <div class="card tasks-box">
                                    <div class="card-body">
                                        <div class="d-flex mb-2">
                                            <a href="javascript:void(0)"
                                                class="text-muted fw-semibold fs-14 flex-grow-1">#VL2462</a>
                                            <div class="dropdown">
                            ...
                            <div id="completed-task" class="tasks">
                                <div class="card tasks-box">
                                    <div class="card-body">
                                        <div class="d-flex mb-2">
                                            <h6 class="fs-16 mb-0 flex-grow-1 text-truncate task-title"><a
                                                    href="apps-tasks-details.php" class="link-dark d-block">Create a
                                                    Blog
                                                    Template UI</a></h6>
                                            <div class="dropdown">
                            ...
                            <div id="new-task" class="tasks">
                                <div class="card tasks-box">
                                    <div class="card-body">
                                        <div class="d-flex mb-2">
                                            <a href="javascript:void(0)"
                                                class="text-muted fw-semibold fs-14 flex-grow-1">#VL5287</a>
                                            <div class="dropdown">
