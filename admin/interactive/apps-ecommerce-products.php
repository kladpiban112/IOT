                                    ...
                                    <h2 class="accordion-header" id="flush-headingBrands">
                                        <button class="accordion-button bg-transparent shadow-none" type="button"
                                            ...
                                            <span class="text-muted text-uppercase fs-12 fw-medium">Brands</span> <span
                                                class="badge bg-info rounded-pill align-middle ms-1 filter-badge"></span>
                                        </button>
                                    </h2>
                                ...
                                <div class="card-header border-0">
                                    <div class="row g-4">
                                        <div class="col-sm-auto">
                                            <div>
                                                <a href="apps-ecommerce-add-product.php" class="btn btn-info"
                                            ...
                                            <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0"
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link text-body active fw-semibold"
                                                        data-bs-toggle="tab" href="#productnav-all" role="tab">
                                                        All <span
