                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
                            <div class="col">
                                <div class="card">
                                    <a class="card-header bg-soft-primary border-0" data-bs-toggle="collapse" href="#leadDiscovered" role="button" aria-expanded="false" aria-controls="leadDiscovered">
                            ...
                            <div class="col">
                                <div class="card">
                                    <a class="card-header bg-soft-info border-0" data-bs-toggle="collapse" href="#contactInitiated" role="button" aria-expanded="false" aria-controls="contactInitiated">
                            ...
                            <div class="col">
                                <div class="card">
                                    <a class="card-header bg-soft-primary border-0" data-bs-toggle="collapse" href="#needsIdentified" role="button" aria-expanded="false" aria-controls="needsIdentified">
                            ...
                            <div class="col">
                                <div class="card">
                                    <a class="card-header bg-soft-info border-0" data-bs-toggle="collapse" href="#meetingArranged" role="button" aria-expanded="false" aria-controls="meetingArranged">
