                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="javascript:void(0);" class="currency_name flex-grow-1 link-dark ms-2">Bitcoin (BTC)</a>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="javascript:void(0);" class="currency_name flex-grow-1 link-dark ms-2">Ethereum (ETH)</a>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="javascript:void(0);" class="currency_name flex-grow-1 link-dark ms-2">Monero (XMR)</a>
                                                            </div>
                                                        </td>
                                                        <td class="type text-danger">Sell</td> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="javascript:void(0);" class="currency_name flex-grow-1 link-dark ms-2">Maker (MKR)</a>
                                                            </div>
                                                        </td>
                                                        <td class="type text-success">Buy</td> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="javascript:void(0);" class="currency_name flex-grow-1 link-dark ms-2">Yearn.finance  (YFI)</a>
                                                            </div>
                                                        </td>
                                                        <td class="type text-success">Buy</td> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="currency_name">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="javascript:void(0);" class="currency_name flex-grow-1 link-dark ms-2">Litecoin (LTC)</a>
                                                            </div>
                                                        </td>
                                                        <td class="type text-success">Buy</td> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="currency_name">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="javascript:void(0);" class="currency_name flex-grow-1 link-dark ms-2">Dash (DASH)</a>
                                                            </div>
                                                        </td>
                                                        <td class="type text-success">Buy</td> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="currency_name">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="javascript:void(0);" class="currency_name flex-grow-1 link-dark ms-2">Neo (NEO)</a>
                                                            </div>
                                                        </td>
                                                        <td class="type text-danger">Sell</td> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="currency_name">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="javascript:void(0);" class="currency_name flex-grow-1 link-dark ms-2">Enzyme (MLN)</a>
                                                            </div>
                                                        </td>
                                                        <td class="type text-danger">Sell</td> 
