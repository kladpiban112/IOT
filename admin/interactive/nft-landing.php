                    ...
                    <div class="col-lg-4 product-item artwork crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Creative Filtered Portrait</a></h5>
                    ...
                    <div class="col-lg-4 product-item music crypto-card games">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">The Chirstoper</a></h5>
                    ...
                    <div class="col-lg-4 product-item crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Abstract Face Painting</a></h5>
                    ...
                    <div class="col-lg-4 product-item games music 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Long-tailed Macaque</a></h5>
                    ...
                    <div class="col-lg-4 product-item artwork music crypto-card">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.php" class="link-dark">Robotic Body Art</a></h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </div>
                            <div class="card-footer border-top border-top-dashed">
                                <div class="d-flex align-items-center">
