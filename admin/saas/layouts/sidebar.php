            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bxs-dashboard"></i> <span><?=$lang['t-dashboards']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bx-layer"></i> <span><?=$lang['t-apps']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bx-layout"></i> <span><?=$lang['t-layouts']?></span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarLayouts">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="layouts-vertical.php" target="_blank" class="nav-link">Vertical</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAuth" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bx-user-circle"></i> <span><?=$lang['t-authentication']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarPages" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bx-file"></i> <span><?=$lang['t-pages']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarUI" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bx-palette"></i> <span><?=$lang['t-base-ui']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAdvanceUI" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bx-briefcase-alt"></i> <span><?=$lang['t-advance-ui']?></span>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="widgets.php">
                        <i class="bx bx-aperture"></i> <span><?=$lang['t-widgets']?></span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarForms" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bx-receipt"></i> <span><?=$lang['t-forms']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarTables" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bx-table"></i> <span><?=$lang['t-tables']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarCharts" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bx-doughnut-chart"></i> <span><?=$lang['t-charts']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarIcons" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bx-tone"></i> <span><?=$lang['t-icons']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarMaps" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bx-map-alt"></i> <span><?=$lang['t-maps']?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarMultilevel" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bx-sitemap"></i> <span><?=$lang['t-multi-level']?></span>
                    </a>
