        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="dashboard-nft.php" class="nav-link" data-key="t-nft"> <?=$lang['t-nft']?> <span
                ...
                <li class="nav-item"> <a class="nav-link menu-link" href="#sidebarLanding" data-bs-toggle="collapse"
                        ...
                        <span class="badge badge-pill bg-danger"><?=$lang['t-new']?></span>
                    </a>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarForms">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="forms-select2.php" class="nav-link" data-key="t-select2">Select2 <span
